...
//I2C is used to connect to the sensors for data aquisition. SPI is used to pass data between the myRIO and the Arduino.
...
volatile byte data1[7]; //HES 1 array of 7 bytes
volatile byte data2[7]; //HES 2 array of 7 bytes
...
void setup()
{
  ...
  ///// Begin as I2C Master /////////////
  Wire.begin(); // Initialise I2C communication as MASTER for reading sensors on bus 0.
...
void loop()
{
  ...
  getAddr3(); // read data from sensor 3 -------------- UNCOMMENT LATER
  getAddr4(); // read data from sensor 4 -------------- UNCOMMENT LATER
